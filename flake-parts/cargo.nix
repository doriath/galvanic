    ...
    let
      ...
      packages =
        ...
        in
        {
          ...
          wasm = buildWasmPackage { name = "galvanic-wasm"; };

          cargo-doc = craneLib.cargoDoc ({ cargoArtifacts = deps-only; } // common-build-args);
        };
      ...
      checks = {
        ...
        rust-fmt = craneLib.cargoFmt ({ inherit (common-build-args) src; } // common-build-args);
